...
public class CreateContact {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("Sanjai");
		...
		driver.findElement(By.id("createContactForm_primaryEmail")).sendKeys("ksk123@gmail.com");
